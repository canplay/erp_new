 ...
 */
function buildRequestAdapter(): ReturnType<typeof axiosRequestAdapter> {
...
export function get(url: string, params?: unknown, config?: unknown): Promise<HttpResponse<unknown>> {
  return alovaInstance.Get(url, { params: params as Record<string, unknown>, ...config as Record<string, unknown> });
}

export function post(url: string, data?: RequestBody, config?: Record<string, unknown>): Promise<HttpResponse<unknown>> {
  return alovaInstance.Post(url, data, config);
}

export function put(url: string, data?: RequestBody, config?: Record<string, unknown>): Promise<HttpResponse<unknown>> {
  return alovaInstance.Put(url, data, config);
}

export function patch(url: string, data?: RequestBody, config?: Record<string, unknown>): Promise<HttpResponse<unknown>> {
  return alovaInstance.Patch(url, data, config);
}

export function del(url: string, params?: unknown, config?: unknown): Promise<HttpResponse<unknown>> {
  return alovaInstance.Delete(url, { params, ...config as Record<string, unknown> });
}

export function upload(url: string, file: File, fieldName = 'file', config?: unknown): Promise<HttpResponse<unknown>> {
...
export function download(url: string, params?: unknown, config?: unknown): Promise<Blob> {
...
function normalizeParams(params?: unknown): Record<string, string | number | boolean> | undefined {
