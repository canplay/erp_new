  ...
  <div class="field-mask-config">
    <q-card flat bordered>
      <q-card-section>
        ...
        <FieldMaskTable
          :field-masks="(filteredFieldMasks as LocalFieldMaskItem[])"
          :columns="columns"
          :mask-strategy-options="maskStrategyOptions"
          @strategy-change="(rule: LocalFieldMaskItem) => handleStrategyChange(rule)"
          @rule-change="(rule: LocalFieldMaskItem) => handleRuleChange(rule)"
          @preview="(rule: LocalFieldMaskItem) => showPreview(rule as LocalFieldMaskItem)"
        />
...
import { useFieldMask } from '@erp-new-frontend-monorepo/composables/src/useFieldMask';;
