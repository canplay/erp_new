...
import FriendCircle from '@erp-new-frontend-monorepo/components/src/FriendCircle.vue';
import type { FriendCirclePost } from '@erp-new-frontend-monorepo/components/src/FriendCircle.vue';
