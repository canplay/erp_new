  ...
  <div class="stepper-indicator">
    <div class="row items-center justify-center q-pa-md">
      <div
        ...
        class="step-item"
        :class="{
          'step-item--active': currentStep === step,
          'step-item--completed': currentStep > step
        }"
      >
        ...
        <div class="step-item__label">{{ $t(`step.${step}`) }}</div>
        <div v-if="step < totalSteps" class="step-item__line" />
      </div>
    </div>
  </div>
</template>
