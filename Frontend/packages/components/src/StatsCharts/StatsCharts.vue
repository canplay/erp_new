/**
 * @file StatsCharts/StatsCharts.vue
 * @description API统计 - 主入口，保持原有公共 API
 * @date 2026-08-22
 */
  ...
  <div class="stats-charts">
    <div class="row q-col-gutter-md">
      ...
      <div class="col-12 col-lg-8">
        <!-- 响应时间趋势 -->
        <ChartCard :title="trendTitle" class="q-mb-md">
      ...
      <div class="col-12 col-lg-4">
        <!-- 分类统计 -->
        <ChartCard :title="categoryTitle" class="q-mb-md">
        ...
        <!-- 性能基线告警 -->
        <ChartCard :title="baselineTitle" :badge-count="baselineAlerts.length" badge-color="negative">
    ...
    <!-- 端点详情表格 -->
    <ChartCard :title="endpointTitle" class="q-mt-md">
      <q-table
        :rows="endpointStats"
