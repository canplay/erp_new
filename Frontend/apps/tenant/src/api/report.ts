 ...
 * @brief 获取报表列表
 */
export async function listReports(params?: ReportListParam) {
  try {
 ...
 * @brief 创建报表
 */
export async function createReport(data: CreateReportParam) {
  try {
 ...
 * @brief 更新报表
 */
export async function updateReport(id: string, data: UpdateReportParam) {
  try {
 ...
 * @brief 更新数据源
 */
export async function updateDataSource(id: string, data: Partial<DataSource>) {
  try {
 ...
 * @brief 执行报表
 */
export async function executeReport(id: string) {
  try {
 ...
 * @brief 获取报表任务列表
 */
export async function listReportTasks(reportId: string) {
  try {
