<template>
  <q-layout view="lHh Lpr lFf">
    ...
    <!-- 命令面板 -->
    <CommandPalette :ref="(el: any) => { if (commandPaletteRef && typeof commandPaletteRef === 'object' && 'value' in commandPaletteRef) commandPaletteRef.value = el }" :commands="commands" />
  </q-layout>
</template>
...
import CommandPalette from '@/components/CommandPalette/Main.vue';
...
function openCommandPalette() {
  (commandPaletteRef.value as any)?.open?.();
}
function closeCommandPalette() {
  (commandPaletteRef.value as any)?.close?.();
}
...
const mobileNavItems = computed(() => [
  ...
  { path: '/ctp', label: t('menu.ctpLock'), icon: 'lock', adminOnly: true },
  { path: '/xlt', label: t('menu.xltDashboard'), icon: 'local_parking', adminOnly: true },
