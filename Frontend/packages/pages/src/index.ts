 ...
 * 
 * Dual-mode export:
 * 1. Named barrel exports for admin/ops/social convenience
 * 2. Full re-export for tenant sub-path compatibility
 * 
 * Tenant imports via: @erp-new-frontend-monorepo/pages/src/<path>.vue
...
// === Page components (PascalCase, for programmatic access) ===
