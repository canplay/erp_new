...
import CommandPalette from '@erp-new-frontend-monorepo/components/src/CommandPalette/Main.vue';
import type { Command } from '@erp-new-frontend-monorepo/components/src/CommandPalette/Main.vue';
...
function openCommandPalette() {
  (commandPaletteRef.value as { open?: () => void } | null)?.open?.();
}
function closeCommandPalette() {
  (commandPaletteRef.value as { close?: () => void } | null)?.close?.();
}
