...
/// 网络支付记录
#[derive(Debug, Clone, Serialize, Deserialize, FromRow)]
pub struct PaymentWeb {pub id: Option<String>, pub create_user: Option<String>, pub create_date: Option<String>, pub update_user: Option<String>, pub update_date: Option<String>, pub orderform_code: Option<String>, pub payment_time: Option<String>, pub payment_amount: Option<i64>, pub payment_type: Option<String>, pub numbering: Option<String>, pub name: Option<String>, pub principal: Option<String>, pub telephone: Option<String>, pub address: Option<String>, pub receipt_status: Option<String>, pub status: Option<String>, pub openid: Option<String>, pub type_: Option<String>, pub receipt_number: Option<String>, pub serial_number: Option<String>}
