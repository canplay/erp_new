...
import { useHealthDashboard } from '@erp-new-frontend-monorepo/composables/src/useHealthDashboard';;
import HealthPerformanceTab from '@erp-new-frontend-monorepo/components/src/HealthPerformanceTab.vue';
import HealthWebSocketTab from '@erp-new-frontend-monorepo/components/src/HealthWebSocketTab.vue';
import HealthApiTab from '@erp-new-frontend-monorepo/components/src/HealthApiTab.vue';
import HealthErrorsTab from '@erp-new-frontend-monorepo/components/src/HealthErrorsTab.vue';
import HealthChecksTab from '@erp-new-frontend-monorepo/components/src/HealthChecksTab.vue';
